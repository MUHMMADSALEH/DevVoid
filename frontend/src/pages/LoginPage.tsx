    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F8F7F2] py-12 px-4">
      <div className="max-w-md w-full space-y-8 bg-white/80 rounded-2xl p-8 flex flex-col items-center">
        <div className="flex flex-col items-center">
          <h2 className="text-4xl font-bold text-center font-serif mb-2">Welcome Back</h2>
          <p className="text-md text-gray-600 mb-6 text-center">Sign in to your account</p>
        </div>
        ...
        <div className="mt-6 text-center w-full">
          ...
          <Link to="/register" className="text-[#FFD600] font-semibold hover:underline">Register</Link>
        </div>
      </div>
    </div>
  );
